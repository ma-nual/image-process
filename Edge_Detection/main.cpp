...
int main(int argc, char *argv[])
{
    ...
    Mat image = imread("E:/store/cv work/10.jpg");
//    Mat image = imread("D://Qt//qtcreator-2.1.0//data_project//image//12121.jpg");
    ...
    namedWindow("gaus image",CV_WINDOW_NORMAL);
    ...
    namedWindow("XY grad",CV_WINDOW_NORMAL);
    imshow("XY grad", imageXY);

    //对梯度幅值进行非极大值抑制
    Mat localImage;
    NonLocalMaxValue(imageXY, localImage, theta,imageX,imageY);
    namedWindow("Non local maxinum image",CV_WINDOW_NORMAL);
    ...
    namedWindow("opencv canny image",CV_WINDOW_NORMAL);
